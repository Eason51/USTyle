...
public class PostRequest extends AsyncTask<String, Void, String> {
    ...
    public PostRequest(PostRequestResult prr, AfterPost afterPost){
        this.postRequestResult = prr;
        this.afterPost = afterPost;
    }

    public PostRequest(PostRequestResult prr, Context context){
        this.postRequestResult = prr;
        this.context = context;
    }

    public PostRequest(PostRequestResult prr, AfterPost afterPost, Context context){
        this.postRequestResult = prr;
        this.afterPost = afterPost;
        this.context = context;
    }
